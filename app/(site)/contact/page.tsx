          ...
          <div className="grid gap-10 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-4 text-text-light leading-relaxed">
                Whether you have questions about the festival, want to register interest in a trade stand for 2027, enter the cheese race, or get involved as a volunteer — we&apos;re here to help.
              </p>
