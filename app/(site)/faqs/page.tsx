...
function faqPlainText(key: typeof allFaqOrder[number]): string {
  const map: Record<string, string> = {
    ...
    gettingThere: 'Shaftesbury is well connected by road, rail and bus. The nearest train stations are Gillingham (8 miles) and Tisbury (10 miles), and local buses run into town from across the region.',
    parking: 'Town-centre parking in Shaftesbury is limited on festival day. Please car-share where possible and allow extra time. Use postcode SP7 8JY for the High Street.',
    dogs: 'Well-behaved dogs are welcome, particularly in outdoor areas. Please be mindful of crowds and hot surfaces.',
    finish: 'All Sunday activities conclude at approximately 5pm.',
    booking: 'Some elements are FREE but require booking, including Gold Hill Cheese Race entry and your place in the audience for the MasterChefs LIVE demos. Booking in advance is via Eventbrite.',
    ...
    traders: 'Yes — expressions of interest are now open for the next festival on Sunday 2nd May 2027. The Street Market features over 100 traders. Register your interest via shaftesbury-food-festival.co.uk/trade-stands.',
