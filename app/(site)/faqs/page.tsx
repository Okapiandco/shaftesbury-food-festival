...
function faqPlainText(key: typeof allFaqOrder[number]): string {
  const map: Record<string, string> = {
    ...
    highlights: 'Sunday features Gold Hill Cheese Race, MasterChefs LIVE Demos, 100+ trader Street Market, live music, the traditional Byzantine Walk, A Feast For The Eyes art exhibition, and family activities including the Ingredients Hunt and Children’s Art Competition.',
